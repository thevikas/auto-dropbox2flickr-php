    ...
    class phpFlickr {
        ...
        function getRequestToken($callback) {
            ...
            $data = array(
                ...
                'oauth_version' => "1.0",
                'oauth_callback' => 'http://thevikas.com/',
            );
            ...
            {
                print_r($_SESSION);
                file_put_contents('del.txt', json_encode($_SESSION));
                echo "Goto location: ".$this->oauthauthorize_endpoint.'?perms=write&oauth_token='.$reponse['oauth_token'] . "\n";
            }
        ...
        function getAccessToken($verifier) {
            ...
            $obj = json_decode(file_get_contents('del.txt'),true);
            $token = $obj['oauth_tokentmp'];
            $sec = $obj['oauth_secrettmp'];
            if (session_id() == '')
            session_start();
